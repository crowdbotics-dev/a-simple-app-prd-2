"""
Django settings for a_simple_app_prd_2 project.
...
ROOT_URLCONF = 'a_simple_app_prd_2.urls'
...
WSGI_APPLICATION = 'a_simple_app_prd_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "A simple app PRD Support <support@a-simple-app-prd-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "a_simple_app_prd_2 API",
    "DESCRIPTION": "API documentation for a_simple_app_prd_2 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "a_simple_app_prd_2.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "a_simple_app_prd_2.storage_backends.AzureStaticStorage"
